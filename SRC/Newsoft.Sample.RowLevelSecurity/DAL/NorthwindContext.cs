...
//     Configuration file:     "Newsoft.Sample.RowLevelSecurity\App.config"
//     Connection String Name: "NorthwindConnection"
//     Connection String:      "data source=SERROX20;initial catalog=NORTHWND;user id=sa;password=**zapped**;"
// ------------------------------------------------------------------------------------------------
...
namespace Newsoft.Sample.RowLevelSecurity.DAL
{
    ...
    public interface INorthwindContext : IDisposable
    {
        ...
        DbSet<Tenant> Tenants { get; set; } // Tenant
    ...
    // ************************************************************************
    // Database context
    public partial class NorthwindContext : Newsoft.Sample.RowLevelSecurity.DAL.TenantAwareDbContext, INorthwindContext
    {
        ...
        public NorthwindContext(string connectionString, System.Data.Entity.Infrastructure.DbCompiledModel model) : base(connectionString, model)
        {
            InitializePartial();
        }
    ...
    public partial class FakeNorthwindContext : INorthwindContext
    {
        ...
        public FakeNorthwindContext()
        {
            ...
            Tenants = new FakeDbSet<Tenant>("Id");
    ...
    public partial class Employee
    {
        ...
        public Guid? SecuredByTenantId { get; set; } // SecuredByTenantId
    ...
    public partial class EmployeeConfiguration : EntityTypeConfiguration<Employee>
    {
        ...
        public EmployeeConfiguration(string schema)
        {
            ...
            Property(x => x.SecuredByTenantId).HasColumnName("SecuredByTenantId").IsOptional().HasColumnType("uniqueidentifier");
    ...
    // Tenant
    public partial class TenantConfiguration : EntityTypeConfiguration<Tenant>
    {
